...
import com.nuon.goamall.dto.OrderAddressDTO;
import com.nuon.goamall.enumeration.OrderStatus;
...
public class Order extends BaseEntity {
    ...
    public void setSnapItems(List<OrderSku> orderSkuList) {
        ...
        this.snapItems = GenericAndJson.object2Json(orderSkuList);
    }

    public List<OrderSku> getSnapItems() {
        List<OrderSku> list = GenericAndJson.json2Object(this.snapItems,
    ...
    public OrderAddressDTO getSnapAddress() {
        ...
        OrderAddressDTO o = GenericAndJson.json2Object(this.snapAddress,
    ...
    public void setSnapAddress(OrderAddressDTO address) {
        this.snapAddress = GenericAndJson.object2Json(address);
    }
}
